...
//
// https://github.com/01ne/pty/issues/162
//
...
//
// https://github.com/01ne/pty/issues/114
// https://github.com/01ne/pty/issues/88
//
//nolint:paralleltest // Potential in (*os.File).Fd().
...
func prepare(t *testing.T) (ptmx *os.File, done func()) {
	...
	if runtime.GOOS == "darwin" {
		...
		t.Log("> https://github.com/01ne/pty/issues/52")
		t.Log("> https://github.com/01ne/pty/pull/53")
